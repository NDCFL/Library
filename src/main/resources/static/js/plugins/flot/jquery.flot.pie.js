	...
	function init(plot) // this is the "body" of the plugin
	{
		...
		function drawDonutHole(layer)
		{
			...
			if(options.series.pie.innerRadius > 0)
			{
				...
				layer.closePath();
				layer.restore();
				// TOVo: add extra shadow inside hole (with a mask) if the pie is tilted.
			}
		}
			...
			for (var i = 0; i < slices.length; ++i)
			{
				...
				if(s.pie.show)
				{
					...
					else
					{
						...
						arrPoint = [x,y];
						// TOVo: perhaps do some mathmatical trickery here with the Y-coordinate to compensate for pie tilt?
