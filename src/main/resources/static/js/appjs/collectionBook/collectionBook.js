...
$('#mytab').bootstrapTable({
    ...
    url: "/collectionBook/list",//要请求数据的文件路径
    ...
    columns: [
        ...
        },
        {
            ...
            formatter: function (value, row, index) {
                var e = '<a title="编辑" href="javascript:void(0);" id="collectionBook"  data-toggle="modal" data-id="\'' + row.id + '\'" data-target="#myModal" onclick="return edit(\'' + row.id + '\')"><i class="glyphicon glyphicon-pencil" alt="修改" style="color:green">修改</i></a> ';
...
$('#search_btn').click(function () {
    $('#mytab').bootstrapTable('refresh', {url: '/collectionBook/list'});
})
...
$("#updateSta").click(function () {
    layer.confirm('确认要执行批量修改状态吗？', function (index) {
        $.post(
            "/collectionBook/deleteManyCollectionBook",
            {
                "manyId": $("#statusId").val(),
                "status": $("#status").val()
            },
