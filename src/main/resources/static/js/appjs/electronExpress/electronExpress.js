...
$('#mytab').bootstrapTable({
    ...
    url: "/electronExpress/list",//要请求数据的文件路径
...
$("#updateSta").click(function () {
    layer.confirm('确认要执行批量修改状态吗？', function (index) {
        $.post(
            "/electronExpress/deleteManyElectronExpress",
            {
                "manyId": $("#statusId").val(),
                "status": $("#status").val()
            },
