...
$('#mytab').bootstrapTable({
    ...
    url: "/readerBook/list",//要请求数据的文件路径
    ...
    columns: [
        ...
        },
        {
            ...
            field: '',
            formatter: function (value, row, index) {
                var e = '<a title="编辑" href="javascript:void(0);" id="readerBook"  data-toggle="modal" data-id="\'' + row.id + '\'" data-target="#myModal" onclick="return edit(\'' + row.id + '\')"><i class="glyphicon glyphicon-pencil" alt="修改" style="color:green">修改</i></a> ';
...
$('#search_btn').click(function () {
    $('#mytab').bootstrapTable('refresh', {url: '/readerBook/list'});
})
...
$("#updateSta").click(function () {
    layer.confirm('确认要执行批量修改状态吗？', function (index) {
        $.post(
            "/readerBook/deleteManyReaderBook",
            {
                "manyId": $("#statusId").val(),
                "status": $("#status").val()
            },
