...
import com.library.common.service.GeneratorService;
import com.library.common.utils.GenUtils;
...
public class GeneratorController {
	...
	public void code(HttpServletRequest request, HttpServletResponse response,
		...
		response.reset();
		response.setHeader("Content-Disposition", "attachment; filename=\"library.zip\"");
